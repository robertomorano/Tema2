...
public class Ej6 {
	...
	public static void main(String[] args) {
		...
		do {
			...
			} else if ((resp1.equals(PAPEL)) && (resp2.equals(PIEDRA)) || (resp1.equals(TIJERAS)) && (resp2.equals(PAPEL))
					|| (resp1.equals(PIEDRA)) && (resp2.equals(TIJERAS))) {
				System.out.println("Gana jugador 1 ");
			} else if (((resp2.equals(PAPEL)) && (resp1.equals(PIEDRA)) || (resp2.equals(TIJERAS)) && (resp1.equals(PAPEL))
					|| (resp2.equals(PAPEL)) && (resp1.equals(PIEDRA)))) {
